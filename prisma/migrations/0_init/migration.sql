...
CREATE TABLE "water_supply_status" (
    ...
    CONSTRAINT "water_supply_status_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "water_supply_status" ADD CONSTRAINT "water_supply_status_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
