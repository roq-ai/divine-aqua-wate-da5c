...
import { createWaterSupplyStatus } from 'apiSdk/water-supply-statuses';
...
function WaterSupplyStatusCreatePage() {
  ...
  const handleSubmit = async (values: WaterSupplyStatusInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createWaterSupplyStatus(values);
      resetForm();
