...
import { getWaterSupplyStatusById } from 'apiSdk/water-supply-statuses';
...
function WaterSupplyStatusViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Water Supply Status Detail View
          </Text>
          {hasAccess('water_supply_status', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/water-supply-statuses/edit/${data?.id}`} passHref legacyBehavior>
              <Button
